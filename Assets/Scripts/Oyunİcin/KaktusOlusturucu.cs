...
public class KaktusOlusturucu : MonoBehaviour
{
    ...
    void KaktusleriOlustur()
    {
        for (int i = 0; i < klonlamaSayisi; i++)
        {
            ...
            // Klonlanan kaktüsün rotasyonunu ayarlayýn
            klonlananKaktus.transform.rotation = Quaternion.Euler(-90f, Random.Range(0f, 360f), 0f);
        }
    }
}
